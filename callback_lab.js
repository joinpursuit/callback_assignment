...
console.log(caller(2, 5, addNumbers));
...
function callCallback (callback, boolean){
  if (boolean === true){
  return callback(2, 6);
  } else {
...
let result = callCallback(addNumbers, true)
console.log(result)
// ## Question Three
//
...
function addThenMultiply (num, callback1, callback2){
...
console.log (addThenMultiply(5, add, multiply))
...
forEachElem([1,4,5,6], displayArr)
...
logArrTypes([1,"Hi", true, {color: "green"}], forEachElem)
console.log('------------------')
//Is this right?
//
// ## Question Six
...
console.log(myMap([3,5,6], timesThree))
//
...
console.log(myFilter([1,4,6,7, -3], tellBoolean))
