...
// ```
onsole.log('Number 1:------------------------------')
const joeyTribbiani = (oldFunction) => {
  return console.log('How you doin?')
}
joeyTribbiani()
...
onsole.log('Number 2:------------------------------')
let trueBoolean = (1 === 1);
let falseBoolean = (1 === 2);
const checkTrue = (callBackFunction, boolean) => {
  if(boolean === true) {
...
checkTrue(joeyTribbiani(), trueBoolean)
...
const doubleCallback = (num1, callBack1, callBack2) => {
  firstReturn = callBack1(num1)
  secondReturn = callBack2(firstReturn)
  return secondReturn
}
let testDouble = doubleCallback(7, square, add5)
...
const shouldIBuyThis = (balance, spendingEquation) => {
  if (spendingEquation(balance) === true) {
    return 'Go shopping!'
  } else if (spendingEquation(balance) === false) {
    return 'Keep saving'
  }
}
console.log(shouldIBuyThis(50, horribleSaver))
...
const loggingElemMoney = (element) => {
  return (console.log('$ '+ element))
}
let array1 = [1, 2, 3, 4];

const forEachElem = (array, callBackFunc) => {
  for (let i = 0; i < array.length; i ++){
    functionOnArray = callBackFunc(array[i])
  } return functionOnArray
}
forEachElem(array1, loggingElemMoney)



console.log('Number 5b:------------------------------')

const loggingElem = (element) => {
  return console.log(element)
}
array3 = [5, 6 ,7, 8]
forEachElem(array3, loggingElem)


console.log('Number 5c:------------------------------')
let myRandomArray = [7, 'Hello', false]
const logArrTypes = (element) => {
  console.log(`${element} - ${typeof element}`)
}
forEachElem(myRandomArray, logArrTypes)
...
console.log(myMap(array4, mult3))

console.log('Number 6b:------------------------------')
let array5 = ['We', 'we\'re', 'on', 'a', 'break!']
const allCaps = (element) => {
  return element.toUpperCase()
}
console.log(myMap(array5, allCaps))
//
// ## Question Seven
//
...
const ifGreater5 = (element) => {
  return element > 5
}
let array6 = [2, 5, 12, 19, 20, 23];
...
console.log(myFilter(array6, ifGreater5))

console.log('Number 7b:------------------------------')
const checkEven = (element) => {
  return (element % 2 !== 0)
}
console.log(myFilter(array6, checkEven))

console.log('Number 7c:------------------------------')
const checkShort = (str) => {
  return str.length >= 4
}

let array7 = ['Smelly', 'cat', 'what', 'are', 'they', 'feeding', 'you']
console.log(myFilter(array7, checkShort))
